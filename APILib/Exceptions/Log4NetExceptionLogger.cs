...
namespace SignalAPILib.Exceptions
{
    ///-------------------------------------------------------------------------------------------------
    /// <summary>  Exception logger that outputs to a Log4Net logger. An ExceptionLogger can be used with 
    ///            a WebAPI 2.0 or greater project. It cannot be used with an MVC app.</summary>
    ///
