...
namespace SignalAPILib
{
    public class ClientApi<TEntity> where TEntity : class
    {
        ...
        // private static readonly string UriString = @"http://sg-azdev-sv-001/api/";
        // private static readonly string UriString = @"http://localhost:56410/api/";
        ...
        {
            {typeof(Note), "Notes" },
            {typeof(Case), "LisCases" },
            {typeof(Payor), "Payors"},
            {typeof(PayorGroup), "PayorGroups" },
            {typeof(Physician), "Physicians" },
            {typeof(CaseBillingReport), "CaseBillingReports" },
            {typeof(EnumListItem), "EnumListItems" },
            {typeof(BillingStatusCase), "BillingStatusCases" },
            {typeof(BillingEvent), "BillingEvents" },
            {typeof(ViewModel.Configuration), "Configurations" },
        };
